...
string = "Hollywood	Well		Foot	New York		Spring	Court		Tube	Point		Tablet	Slip		Date	Drill		Lemon	Bell
...
Word.find(4).update(word: 'New York')
Word.destroy(5)
Word.find(176).update(word: 'Scuba Diver')
Word.destroy(177)
Word.find(209).update(word: 'Ice Cream')
Word.destroy(210)
Word.find(228).update(word: 'Loch Ness')
Word.destroy(229)